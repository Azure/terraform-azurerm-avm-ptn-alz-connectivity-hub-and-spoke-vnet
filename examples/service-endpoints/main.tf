...
module "test" {
  ...
  hub_virtual_networks = {
    primary = {
      # Disable all optional hub resources to keep this example lightweight.
      enabled_resources = {
        firewall                              = false
      ...
      hub_virtual_network = {
        ...
        # Configure subnet Service Endpoints using the preferred simple form.
        # Provide the service names directly - no location objects are required.
        subnets = {
          workload = {
            name              = "snet-workload"
