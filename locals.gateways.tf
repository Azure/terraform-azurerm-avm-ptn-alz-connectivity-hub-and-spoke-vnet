locals {
  ...
  virtual_network_gateways_express_route = {
    for hub_network_key, hub_network_value in local.hub_virtual_networks : "${hub_network_key}-express-route" => {
  ...
  virtual_network_gateways_express_route_enabled = {
    for hub_network_key, hub_network_value in local.hub_virtual_networks : hub_network_key => hub_network_value.enabled_resources.virtual_network_gateway_express_route
  }
...
locals {
  virtual_network_gateways_vpn = {
    for hub_network_key, hub_network_value in local.hub_virtual_networks : "${hub_network_key}-vpn" => {
  ...
  virtual_network_gateways_vpn_enabled = {
    for hub_network_key, hub_network_value in local.hub_virtual_networks : hub_network_key => hub_network_value.enabled_resources.virtual_network_gateway_vpn
  }
